...
Feels like my reciprocal anchor with reality (the link between self and other, the hard surface of the mirror) is fully in its next generation, which means I can lean against it, actually _use_ it as an anchor.
