...
there's something in my system happening around ... refactoring connections in relationality? or _sorting_ the connections, sorting the layers of the connections as I keep them in the reality of my mental model, so that their interaction with the layers of the connections as they exist in relationality (the space of co-knowing) is... useful? it feels like playing cat's cradle with a hand in each realm - the shared realm and my own

to an equal degree it is putting myself back in my place :) as simple as knowing "ah my friends are here, and I remain incapable of operating a group, autism remains firmly in play". Anthony and Kristi are here, and it's easier for me to model it as I'm visiting _them_
