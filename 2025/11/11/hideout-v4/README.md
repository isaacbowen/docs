---
description: >-
  or v4.4 or something, it's evolved a little bit, clarified, expanded and
  settled
---
...
this model is "agnostic as possible" but maybe it's meta-agnostic? a tool about which I am _not_ agnostic, and together we are navigating agnostically, maintaining the degrees of freedom needed to adjust course, able to reverse at any time. this model then might be the shape of the ship I'm talking through space _about which_ the ship itself is agnostic.
...
"body", for this model, is my proprioceptive "me". (complication: the measurement scales up _and_ down in interesting ways. consider a single starling, consider its sense of the flock; consider the murmuration's sense of itself.)
