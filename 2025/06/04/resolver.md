...
{% hint style="info" %}
interjection: [this resolved further](resolver/resolver-further-resolved.md). I want to keep the pairing of this content with the LLM responses to it. so, this version is effectively fixed in place, until such time as I'm willing to do another round of LLM-readings, which I find unlikely from here but hey who knows
{% endhint %}
