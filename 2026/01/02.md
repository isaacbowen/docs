...
5. Take-home problem: When you cast your singularity into SO(3), can you label the axes? It’s not the only three-space you live in, but the singularity _there_ might be your primary anchor for orientation as you navigate other three-spaces.
   * Mine (Isaac's) seems to be known-knowable-unknown, a space which has interesting properties as a bridge _between_ three-spaces.
     * In SU(2), the additional dimension is something like _torque_? I notice I can oscillate that property at will without changing my rotation in the three-space.
